...
# -----------------------------
newusers_col.delete_many({"sample_data": True})

sample_customers = []

# ======================================================
# 1. GOVERNMENT EMPLOYEES (NO DEGREE)
# ======================================================
for i in range(15):
    ...
    customer = {
        ...
        "extended_profile": {
            "family": {
                ...
                "children_education": [
                    random.choice(["primary", "secondary", "ol", "al", "tuition"])
    ...
    customer = {
        ...
        "profile": {
            "basic": {
                ...
                "age": age,
                "location": random.choice(
                    ["Colombo", "Kandy", "Negombo", "Moratuwa"]
                ),
                "phone": f"07{random.randint(10000000, 99999999)}"
            }
        },
        "extended_profile": {
            ...
            "education": {
                ...
                "institution": random.choice(
                    ["Local University", "Private Institute", "Government School"]
                ),
                "year_graduated": 2015 + random.randint(0, 8),
                "field_of_study": random.choice(
                    ["IT", "Business", "Engineering", "Arts"]
                )
            },
            "career": {
                "current_job": f"{random.choice(['IT', 'Marketing', 'Sales', 'Finance'])} "
                               f"{random.choice(['Executive', 'Officer', 'Associate'])}",
                "years_experience": age - 22,
...
# ======================================================
# 3. PARENTS WITH SCHOOL CHILDREN
# ======================================================
for i in range(20):
    ...
    customer = {
        ...
        "profile": {
            "basic": {
                ...
                "age": age,
                "location": random.choice(
                    ["Colombo", "Kandy", "Kurunegala", "Ratnapura", "Badulla"]
                ),
                "phone": f"07{random.randint(10000000, 99999999)}"
            }
        },
        "extended_profile": {
            "family": {
                ...
                "children_education": [
                    random.choice(
                        ["primary", "secondary", "ol_prep", "al_prep", "tuition"]
                    ) for _ in range(children_count)
                ],
                "dependents": children_count
            },
...
# -----------------------------
if sample_customers:
    newusers_col.insert_many(sample_customers)

print(f"Inserted {len(sample_customers)} sample users successfully.")
print(f"Inserted {len(sample_customers)} sample customers")
print(f"Total users in database: {newusers_col.count_documents({})}")