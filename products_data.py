...
products = [
    ...
    {
        "id": "prod_slas_01",
        "name": "SLAS Competitive Exam Training",
        "category": "education",
        "subcategory": "slas_training",
        "price": 75000,
        "original_price": 90000,
        "currency": "LKR",
        "images": ["/static/store/slas_training.jpg"],
        "description": "Comprehensive SLAS exam preparation with expert lecturers and mock exams.",
        "features": ["Experienced instructors", "Mock exams", "Study materials", "Weekend classes"],
        "tags": ["slas", "government_exam", "career"],
        "target_segments": ["graduates", "government_job_seekers"],
        "in_stock": True,
        "delivery_options": ["online", "campus"],
        "rating": 4.6,
        "reviews_count": 62,
    ...
    {
        "id": "prod_parttime_01",
        "name": "Part-Time Job Placement Program",
        "category": "employment",
        "subcategory": "part_time_jobs",
        "price": 15000,
        "original_price": 20000,
        "currency": "LKR",
        "images": ["/static/store/part_time_jobs.jpg"],
        "description": "Access verified part-time job opportunities suitable for students and working adults.",
        "features": ["Verified employers", "Flexible hours", "Career guidance"],
        "tags": ["part_time", "jobs", "students"],
        "target_segments": ["students", "working_adults"],
        "in_stock": True,
    ...
    {
        "id": "prod_childedu_01",
        "name": "Children’s Education Support Program",
        "category": "education",
        "subcategory": "child_education",
        "price": 30000,
        "original_price": 36000,
        "currency": "LKR",
        "images": ["/static/store/children_education.jpg"],
        "description": "After-school education services including tutoring and skill development for children.",
        "features": ["Qualified teachers", "Small class sizes", "Skill-based learning"],
        "tags": ["children", "education", "school_support"],
        "target_segments": ["parents", "school_children"],
        "in_stock": True,
        "delivery_options": ["online", "center"],
        "rating": 4.7,
        "reviews_count": 54,
        "created": datetime.utcnow()
    },
    {
        ...
        "currency": "LKR",
        "images": ["/static/store/professional_courses.jpg"],
        "description": "Short-term professional courses to upgrade skills and boost career growth.",
        "features": ["Industry-recognized certificates", "Flexible schedule", "Online access"],
        "tags": ["professional", "skills", "career_growth"],
        "target_segments": ["professionals", "mid_career"],
        "in_stock": True,
        "delivery_options": ["online", "campus"],
        "rating": 4.4,
        "reviews_count": 41,
    ...
    {
        "id": "prod_retail_01",
        "name": "Retail Products – Special Pricing",
        "category": "retail",
        "subcategory": "discount_products",
        "price": 12000,
        "original_price": 16000,
        "currency": "LKR",
        "images": ["/static/store/retail_products.jpg"],
        "description": "Selected retail products available at special discounted prices.",
        "features": ["Limited-time offers", "Quality assured", "Special discounts"],
        "tags": ["retail", "discount", "offers"],
        "target_segments": ["general_customers", "budget_buyers"],
        "in_stock": True,
        "delivery_options": ["home_delivery", "pickup"],
        "rating": 4.2,
        "reviews_count": 29,
        "created": datetime.utcnow()
    }
